...
var style_MOINSDE18ANS_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("-18 ans");
    var labelText = "";
    size = 0;
    ...
    if (value >= 16.000000 && value <= 19.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.000000 && value <= 23.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.000000 && value <= 27.000000) {
            style = [ new ol.style.Style({
